...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/planning/proto/sl_boundary.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SLBoundary& SLBoundary::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto::scc_info_SLBoundary.base);

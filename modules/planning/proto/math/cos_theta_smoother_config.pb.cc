...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/planning/proto/math/cos_theta_smoother_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/planning/proto/math/cos_theta_smoother_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* CosThetaSmootherConfig::descriptor() {
  ::protobuf_modules_2fplanning_2fproto_2fmath_2fcos_5ftheta_5fsmoother_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2fmath_2fcos_5ftheta_5fsmoother_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const CosThetaSmootherConfig& CosThetaSmootherConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2fmath_2fcos_5ftheta_5fsmoother_5fconfig_2eproto::scc_info_CosThetaSmootherConfig.base);
...
::google::protobuf::Metadata CosThetaSmootherConfig::GetMetadata() const {
  protobuf_modules_2fplanning_2fproto_2fmath_2fcos_5ftheta_5fsmoother_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2fmath_2fcos_5ftheta_5fsmoother_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}

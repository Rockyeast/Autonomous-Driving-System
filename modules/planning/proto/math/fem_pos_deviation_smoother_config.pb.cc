...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/planning/proto/math/fem_pos_deviation_smoother_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/planning/proto/math/fem_pos_deviation_smoother_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* FemPosDeviationSmootherConfig::descriptor() {
  ::protobuf_modules_2fplanning_2fproto_2fmath_2ffem_5fpos_5fdeviation_5fsmoother_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2fmath_2ffem_5fpos_5fdeviation_5fsmoother_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const FemPosDeviationSmootherConfig& FemPosDeviationSmootherConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2fmath_2ffem_5fpos_5fdeviation_5fsmoother_5fconfig_2eproto::scc_info_FemPosDeviationSmootherConfig.base);
...
::google::protobuf::Metadata FemPosDeviationSmootherConfig::GetMetadata() const {
  protobuf_modules_2fplanning_2fproto_2fmath_2ffem_5fpos_5fdeviation_5fsmoother_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2fmath_2ffem_5fpos_5fdeviation_5fsmoother_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}

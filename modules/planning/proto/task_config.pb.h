...
#ifndef PROTOBUF_INCLUDED_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto
#define PROTOBUF_INCLUDED_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto 
...
class NewTestDeciderConfig;
class NewTestDeciderConfigDefaultTypeInternal;
extern NewTestDeciderConfigDefaultTypeInternal _NewTestDeciderConfig_default_instance_;
...
class StGenerateDeciderConfig;
class StGenerateDeciderConfigDefaultTypeInternal;
extern StGenerateDeciderConfigDefaultTypeInternal _StGenerateDeciderConfig_default_instance_;
}  // namespace planning
}  // namespace apollo
namespace google {
namespace protobuf {
...
template<> ::apollo::planning::NewTestDeciderConfig* Arena::CreateMaybeMessage<::apollo::planning::NewTestDeciderConfig>(Arena*);
...
template<> ::apollo::planning::StGenerateDeciderConfig* Arena::CreateMaybeMessage<::apollo::planning::StGenerateDeciderConfig>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace apollo {
namespace planning {
...
class CreepDeciderConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.CreepDeciderConfig) */ {
 ...
 private:
  ...
  friend struct ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class NewTestDeciderConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.NewTestDeciderConfig) */ {
 public:
  NewTestDeciderConfig();
  virtual ~NewTestDeciderConfig();

  NewTestDeciderConfig(const NewTestDeciderConfig& from);

  inline NewTestDeciderConfig& operator=(const NewTestDeciderConfig& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  NewTestDeciderConfig(NewTestDeciderConfig&& from) noexcept
    : NewTestDeciderConfig() {
    *this = ::std::move(from);
  }

  inline NewTestDeciderConfig& operator=(NewTestDeciderConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const NewTestDeciderConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const NewTestDeciderConfig* internal_default_instance() {
    return reinterpret_cast<const NewTestDeciderConfig*>(
               &_NewTestDeciderConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    24;

  void Swap(NewTestDeciderConfig* other);
  friend void swap(NewTestDeciderConfig& a, NewTestDeciderConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline NewTestDeciderConfig* New() const final {
    return CreateMaybeMessage<NewTestDeciderConfig>(NULL);
  }

  NewTestDeciderConfig* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<NewTestDeciderConfig>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const NewTestDeciderConfig& from);
  void MergeFrom(const NewTestDeciderConfig& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NewTestDeciderConfig* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  bool has_argn1() const;
  void clear_argn1();
  static const int kArgn1FieldNumber = 1;
  double argn1() const;
  void set_argn1(double value);

  // @@protoc_insertion_point(class_scope:apollo.planning.NewTestDeciderConfig)
 private:
  void set_has_argn1();
  void clear_has_argn1();
...
class StGenerateDeciderConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.StGenerateDeciderConfig) */ {
 public:
  StGenerateDeciderConfig();
  virtual ~StGenerateDeciderConfig();

  StGenerateDeciderConfig(const StGenerateDeciderConfig& from);

  inline StGenerateDeciderConfig& operator=(const StGenerateDeciderConfig& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  StGenerateDeciderConfig(StGenerateDeciderConfig&& from) noexcept
    : StGenerateDeciderConfig() {
    *this = ::std::move(from);
  }

  inline StGenerateDeciderConfig& operator=(StGenerateDeciderConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const StGenerateDeciderConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const StGenerateDeciderConfig* internal_default_instance() {
    return reinterpret_cast<const StGenerateDeciderConfig*>(
               &_StGenerateDeciderConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    25;

  void Swap(StGenerateDeciderConfig* other);
  friend void swap(StGenerateDeciderConfig& a, StGenerateDeciderConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline StGenerateDeciderConfig* New() const final {
    return CreateMaybeMessage<StGenerateDeciderConfig>(NULL);
  }

  StGenerateDeciderConfig* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<StGenerateDeciderConfig>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const StGenerateDeciderConfig& from);
  void MergeFrom(const StGenerateDeciderConfig& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StGenerateDeciderConfig* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  bool has_max_curvature_acceleration_limit() const;
  void clear_max_curvature_acceleration_limit();
  static const int kMaxCurvatureAccelerationLimitFieldNumber = 2;
  double max_curvature_acceleration_limit() const;
  void set_max_curvature_acceleration_limit(double value);

  // optional double minimal_kappa = 3 [default = 0.003];
  bool has_minimal_kappa() const;
  void clear_minimal_kappa();
  static const int kMinimalKappaFieldNumber = 3;
  double minimal_kappa() const;
  void set_minimal_kappa(double value);
  ...
  bool has_lowest_speed() const;
  void clear_lowest_speed();
  static const int kLowestSpeedFieldNumber = 4;
  double lowest_speed() const;
  void set_lowest_speed(double value);

  // @@protoc_insertion_point(class_scope:apollo.planning.StGenerateDeciderConfig)
 private:
  void set_has_total_time();
  void clear_has_total_time();
  void set_has_max_curvature_acceleration_limit();
  void clear_has_max_curvature_acceleration_limit();
  void set_has_minimal_kappa();
  void clear_has_minimal_kappa();
  void set_has_lowest_speed();
  void clear_has_lowest_speed();
  ...
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  double total_time_;
  double max_curvature_acceleration_limit_;
  double minimal_kappa_;
  double lowest_speed_;
  friend struct ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::TableStruct;
};
...
// optional double argn1 = 1 [default = 10];
inline bool NewTestDeciderConfig::has_argn1() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NewTestDeciderConfig::set_has_argn1() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NewTestDeciderConfig::clear_has_argn1() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void NewTestDeciderConfig::clear_argn1() {
  argn1_ = 10;
  clear_has_argn1();
}
inline double NewTestDeciderConfig::argn1() const {
  // @@protoc_insertion_point(field_get:apollo.planning.NewTestDeciderConfig.argn1)
  return argn1_;
}
inline void NewTestDeciderConfig::set_argn1(double value) {
  set_has_argn1();
  argn1_ = value;
  // @@protoc_insertion_point(field_set:apollo.planning.NewTestDeciderConfig.argn1)
}
...
// optional double total_time = 1 [default = 7];
inline bool StGenerateDeciderConfig::has_total_time() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void StGenerateDeciderConfig::set_has_total_time() {
  _has_bits_[0] |= 0x00000001u;
}
inline void StGenerateDeciderConfig::clear_has_total_time() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void StGenerateDeciderConfig::clear_total_time() {
  total_time_ = 7;
  clear_has_total_time();
}
inline double StGenerateDeciderConfig::total_time() const {
  // @@protoc_insertion_point(field_get:apollo.planning.StGenerateDeciderConfig.total_time)
  return total_time_;
}
inline void StGenerateDeciderConfig::set_total_time(double value) {
  set_has_total_time();
  total_time_ = value;
  // @@protoc_insertion_point(field_set:apollo.planning.StGenerateDeciderConfig.total_time)
}

// optional double max_curvature_acceleration_limit = 2 [default = 2];
inline bool StGenerateDeciderConfig::has_max_curvature_acceleration_limit() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void StGenerateDeciderConfig::set_has_max_curvature_acceleration_limit() {
  _has_bits_[0] |= 0x00000002u;
}
inline void StGenerateDeciderConfig::clear_has_max_curvature_acceleration_limit() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void StGenerateDeciderConfig::clear_max_curvature_acceleration_limit() {
  max_curvature_acceleration_limit_ = 2;
  clear_has_max_curvature_acceleration_limit();
}
inline double StGenerateDeciderConfig::max_curvature_acceleration_limit() const {
  // @@protoc_insertion_point(field_get:apollo.planning.StGenerateDeciderConfig.max_curvature_acceleration_limit)
  return max_curvature_acceleration_limit_;
}
inline void StGenerateDeciderConfig::set_max_curvature_acceleration_limit(double value) {
  set_has_max_curvature_acceleration_limit();
  max_curvature_acceleration_limit_ = value;
  // @@protoc_insertion_point(field_set:apollo.planning.StGenerateDeciderConfig.max_curvature_acceleration_limit)
}

// optional double minimal_kappa = 3 [default = 0.003];
inline bool StGenerateDeciderConfig::has_minimal_kappa() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void StGenerateDeciderConfig::set_has_minimal_kappa() {
  _has_bits_[0] |= 0x00000004u;
}
inline void StGenerateDeciderConfig::clear_has_minimal_kappa() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void StGenerateDeciderConfig::clear_minimal_kappa() {
  minimal_kappa_ = 0.003;
  clear_has_minimal_kappa();
}
inline double StGenerateDeciderConfig::minimal_kappa() const {
  // @@protoc_insertion_point(field_get:apollo.planning.StGenerateDeciderConfig.minimal_kappa)
  return minimal_kappa_;
}
inline void StGenerateDeciderConfig::set_minimal_kappa(double value) {
  set_has_minimal_kappa();
  minimal_kappa_ = value;
  // @@protoc_insertion_point(field_set:apollo.planning.StGenerateDeciderConfig.minimal_kappa)
}

// optional double lowest_speed = 4 [default = 12];
inline bool StGenerateDeciderConfig::has_lowest_speed() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void StGenerateDeciderConfig::set_has_lowest_speed() {
  _has_bits_[0] |= 0x00000008u;
}
inline void StGenerateDeciderConfig::clear_has_lowest_speed() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void StGenerateDeciderConfig::clear_lowest_speed() {
  lowest_speed_ = 12;
  clear_has_lowest_speed();
}
inline double StGenerateDeciderConfig::lowest_speed() const {
  // @@protoc_insertion_point(field_get:apollo.planning.StGenerateDeciderConfig.lowest_speed)
  return lowest_speed_;
}
inline void StGenerateDeciderConfig::set_lowest_speed(double value) {
  set_has_lowest_speed();
  lowest_speed_ = value;
  // @@protoc_insertion_point(field_set:apollo.planning.StGenerateDeciderConfig.lowest_speed)
}
...
#endif  // PROTOBUF_INCLUDED_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto

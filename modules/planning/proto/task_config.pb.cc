...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_DpStSpeedOptimizerConfig;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_PiecewiseJerkPathWeights;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ShiftConfig;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_MoveDestLaneConfigTable;
}  // namespace protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto
namespace apollo {
namespace planning {
...
class NewTestDeciderConfigDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<NewTestDeciderConfig>
      _instance;
} _NewTestDeciderConfig_default_instance_;
class StGenerateDeciderConfigDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<StGenerateDeciderConfig>
      _instance;
} _StGenerateDeciderConfig_default_instance_;
}  // namespace planning
}  // namespace apollo
namespace protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto {
...
::google::protobuf::internal::SCCInfo<1> scc_info_NaviPathDeciderConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsNaviPathDeciderConfig}, {
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_MoveDestLaneConfigTable.base,}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_MoveDestLaneConfigTable =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsMoveDestLaneConfigTable}, {
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_ShiftConfig.base,}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_PiecewiseJerkPathOptimizerConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPiecewiseJerkPathOptimizerConfig}, {
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PiecewiseJerkPathWeights.base,}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_SpeedHeuristicOptimizerConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsSpeedHeuristicOptimizerConfig}, {
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_DpStSpeedOptimizerConfig.base,}};
...
static void InitDefaultsNewTestDeciderConfig() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::apollo::planning::_NewTestDeciderConfig_default_instance_;
    new (ptr) ::apollo::planning::NewTestDeciderConfig();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::apollo::planning::NewTestDeciderConfig::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_NewTestDeciderConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsNewTestDeciderConfig}, {}};

static void InitDefaultsStGenerateDeciderConfig() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::apollo::planning::_StGenerateDeciderConfig_default_instance_;
    new (ptr) ::apollo::planning::StGenerateDeciderConfig();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::apollo::planning::StGenerateDeciderConfig::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_StGenerateDeciderConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsStGenerateDeciderConfig}, {}};
...
void InitDefaults() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_NewTestDeciderConfig.base);
  ::google::protobuf::internal::InitSCC(&scc_info_StGenerateDeciderConfig.base);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  0,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::NewTestDeciderConfig, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::NewTestDeciderConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::NewTestDeciderConfig, argn1_),
  0,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, total_time_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, max_curvature_acceleration_limit_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, minimal_kappa_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::StGenerateDeciderConfig, lowest_speed_),
  0,
  1,
  2,
  3,
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 412, 418, sizeof(::apollo::planning::NewTestDeciderConfig)},
  { 419, 428, sizeof(::apollo::planning::StGenerateDeciderConfig)},
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::planning::_NewTestDeciderConfig_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::planning::_StGenerateDeciderConfig_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/planning/proto/task_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "l_time\030\001 \001(\001:\0017\")\n\024NewTestDeciderConfig\022"
      "\021\n\005argn1\030\001 \001(\001:\00210\"\225\001\n\027StGenerateDecider"
      "Config\022\025\n\ntotal_time\030\001 \001(\001:\0017\022+\n max_cur"
      "vature_acceleration_limit\030\002 \001(\001:\0012\022\034\n\rmi"
      "nimal_kappa\030\003 \001(\001:\0050.003\022\030\n\014lowest_speed"
      "\030\004 \001(\001:\00212"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 6090);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/planning/proto/task_config.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::EnumDescriptor* LearningModelInferenceTaskConfig_ModelType_descriptor() {
  protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::Descriptor* CreepDeciderConfig::descriptor() {
  ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const CreepDeciderConfig& CreepDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_CreepDeciderConfig.base);
...
::google::protobuf::Metadata CreepDeciderConfig::GetMetadata() const {
  protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const LaneChangeDeciderConfig& LaneChangeDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_LaneChangeDeciderConfig.base);
  return *internal_default_instance();
}
...
const LearningModelInferenceTaskConfig& LearningModelInferenceTaskConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_LearningModelInferenceTaskConfig.base);
  return *internal_default_instance();
}
...
const LearningModelInferenceTrajectoryTaskConfig& LearningModelInferenceTrajectoryTaskConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_LearningModelInferenceTrajectoryTaskConfig.base);
  return *internal_default_instance();
}
...
const NaviObstacleDeciderConfig& NaviObstacleDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_NaviObstacleDeciderConfig.base);
  return *internal_default_instance();
}
...
const NaviPathDeciderConfig& NaviPathDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_NaviPathDeciderConfig.base);
  return *internal_default_instance();
}
...
const MoveDestLaneConfigTable& MoveDestLaneConfigTable::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_MoveDestLaneConfigTable.base);
  return *internal_default_instance();
}
...
const ShiftConfig& ShiftConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_ShiftConfig.base);
  return *internal_default_instance();
}
...
const NaviSpeedDeciderConfig& NaviSpeedDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_NaviSpeedDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathAssessmentDeciderConfig& PathAssessmentDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathAssessmentDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathBoundsDeciderConfig& PathBoundsDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathBoundsDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathDeciderConfig& PathDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathLaneBorrowDeciderConfig& PathLaneBorrowDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathLaneBorrowDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathReferenceDeciderConfig& PathReferenceDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathReferenceDeciderConfig.base);
  return *internal_default_instance();
}
...
const PathReuseDeciderConfig& PathReuseDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PathReuseDeciderConfig.base);
  return *internal_default_instance();
}
...
const PiecewiseJerkNonlinearSpeedOptimizerConfig& PiecewiseJerkNonlinearSpeedOptimizerConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PiecewiseJerkNonlinearSpeedOptimizerConfig.base);
  return *internal_default_instance();
}
...
const PiecewiseJerkPathOptimizerConfig& PiecewiseJerkPathOptimizerConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PiecewiseJerkPathOptimizerConfig.base);
  return *internal_default_instance();
}
...
const PiecewiseJerkPathWeights& PiecewiseJerkPathWeights::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PiecewiseJerkPathWeights.base);
  return *internal_default_instance();
}
...
const PiecewiseJerkSpeedOptimizerConfig& PiecewiseJerkSpeedOptimizerConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_PiecewiseJerkSpeedOptimizerConfig.base);
  return *internal_default_instance();
}
...
const RuleBasedStopDeciderConfig& RuleBasedStopDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_RuleBasedStopDeciderConfig.base);
  return *internal_default_instance();
}
...
const SpeedBoundsDeciderConfig& SpeedBoundsDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_SpeedBoundsDeciderConfig.base);
  return *internal_default_instance();
}
...
const SpeedHeuristicOptimizerConfig& SpeedHeuristicOptimizerConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_SpeedHeuristicOptimizerConfig.base);
  return *internal_default_instance();
}
...
const DpStSpeedOptimizerConfig& DpStSpeedOptimizerConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_DpStSpeedOptimizerConfig.base);
  return *internal_default_instance();
}
...
const STBoundsDeciderConfig& STBoundsDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_STBoundsDeciderConfig.base);
  return *internal_default_instance();
}
...
void NewTestDeciderConfig::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int NewTestDeciderConfig::kArgn1FieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

NewTestDeciderConfig::NewTestDeciderConfig()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_NewTestDeciderConfig.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:apollo.planning.NewTestDeciderConfig)
}
NewTestDeciderConfig::NewTestDeciderConfig(const NewTestDeciderConfig& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  argn1_ = from.argn1_;
  // @@protoc_insertion_point(copy_constructor:apollo.planning.NewTestDeciderConfig)
}

void NewTestDeciderConfig::SharedCtor() {
  argn1_ = 10;
}

NewTestDeciderConfig::~NewTestDeciderConfig() {
  // @@protoc_insertion_point(destructor:apollo.planning.NewTestDeciderConfig)
  SharedDtor();
}

void NewTestDeciderConfig::SharedDtor() {
}

void NewTestDeciderConfig::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::protobuf::Descriptor* NewTestDeciderConfig::descriptor() {
  ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const NewTestDeciderConfig& NewTestDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_NewTestDeciderConfig.base);
  return *internal_default_instance();
}


void NewTestDeciderConfig::Clear() {
// @@protoc_insertion_point(message_clear_start:apollo.planning.NewTestDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool NewTestDeciderConfig::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:apollo.planning.NewTestDeciderConfig)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional double argn1 = 1 [default = 10];
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(9u /* 9 & 0xFF */)) {
          set_has_argn1();
...
success:
  // @@protoc_insertion_point(parse_success:apollo.planning.NewTestDeciderConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:apollo.planning.NewTestDeciderConfig)
  return false;
#undef DO_
}

void NewTestDeciderConfig::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:apollo.planning.NewTestDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional double argn1 = 1 [default = 10];
  if (cached_has_bits & 0x00000001u) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(1, this->argn1(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:apollo.planning.NewTestDeciderConfig)
}

::google::protobuf::uint8* NewTestDeciderConfig::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:apollo.planning.NewTestDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional double argn1 = 1 [default = 10];
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(1, this->argn1(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:apollo.planning.NewTestDeciderConfig)
  return target;
}

size_t NewTestDeciderConfig::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:apollo.planning.NewTestDeciderConfig)
  size_t total_size = 0;
...
void NewTestDeciderConfig::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:apollo.planning.NewTestDeciderConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const NewTestDeciderConfig* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const NewTestDeciderConfig>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:apollo.planning.NewTestDeciderConfig)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:apollo.planning.NewTestDeciderConfig)
    MergeFrom(*source);
  }
}

void NewTestDeciderConfig::MergeFrom(const NewTestDeciderConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.NewTestDeciderConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_argn1()) {
    set_argn1(from.argn1());
  }
}

void NewTestDeciderConfig::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:apollo.planning.NewTestDeciderConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void NewTestDeciderConfig::CopyFrom(const NewTestDeciderConfig& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:apollo.planning.NewTestDeciderConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool NewTestDeciderConfig::IsInitialized() const {
  return true;
}

void NewTestDeciderConfig::Swap(NewTestDeciderConfig* other) {
  if (other == this) return;
  InternalSwap(other);
}
void NewTestDeciderConfig::InternalSwap(NewTestDeciderConfig* other) {
  using std::swap;
  swap(argn1_, other->argn1_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
}

::google::protobuf::Metadata NewTestDeciderConfig::GetMetadata() const {
  protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
void StGenerateDeciderConfig::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int StGenerateDeciderConfig::kTotalTimeFieldNumber;
const int StGenerateDeciderConfig::kMaxCurvatureAccelerationLimitFieldNumber;
const int StGenerateDeciderConfig::kMinimalKappaFieldNumber;
const int StGenerateDeciderConfig::kLowestSpeedFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

StGenerateDeciderConfig::StGenerateDeciderConfig()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_StGenerateDeciderConfig.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:apollo.planning.StGenerateDeciderConfig)
}
StGenerateDeciderConfig::StGenerateDeciderConfig(const StGenerateDeciderConfig& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&total_time_, &from.total_time_,
    ...
    reinterpret_cast<char*>(&total_time_)) + sizeof(lowest_speed_));
  // @@protoc_insertion_point(copy_constructor:apollo.planning.StGenerateDeciderConfig)
}

void StGenerateDeciderConfig::SharedCtor() {
  total_time_ = 7;
  max_curvature_acceleration_limit_ = 2;
  minimal_kappa_ = 0.003;
  lowest_speed_ = 12;
}

StGenerateDeciderConfig::~StGenerateDeciderConfig() {
  // @@protoc_insertion_point(destructor:apollo.planning.StGenerateDeciderConfig)
  SharedDtor();
}

void StGenerateDeciderConfig::SharedDtor() {
}

void StGenerateDeciderConfig::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::protobuf::Descriptor* StGenerateDeciderConfig::descriptor() {
  ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const StGenerateDeciderConfig& StGenerateDeciderConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::scc_info_StGenerateDeciderConfig.base);
  return *internal_default_instance();
}


void StGenerateDeciderConfig::Clear() {
// @@protoc_insertion_point(message_clear_start:apollo.planning.StGenerateDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool StGenerateDeciderConfig::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:apollo.planning.StGenerateDeciderConfig)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional double max_curvature_acceleration_limit = 2 [default = 2];
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(17u /* 17 & 0xFF */)) {
          set_has_max_curvature_acceleration_limit();
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, &max_curvature_acceleration_limit_)));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      // optional double minimal_kappa = 3 [default = 0.003];
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(25u /* 25 & 0xFF */)) {
          set_has_minimal_kappa();
      ...
      // optional double lowest_speed = 4 [default = 12];
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(33u /* 33 & 0xFF */)) {
          set_has_lowest_speed();
...
success:
  // @@protoc_insertion_point(parse_success:apollo.planning.StGenerateDeciderConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:apollo.planning.StGenerateDeciderConfig)
  return false;
#undef DO_
}

void StGenerateDeciderConfig::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:apollo.planning.StGenerateDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional double max_curvature_acceleration_limit = 2 [default = 2];
  if (cached_has_bits & 0x00000002u) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(2, this->max_curvature_acceleration_limit(), output);
  }

  // optional double minimal_kappa = 3 [default = 0.003];
  if (cached_has_bits & 0x00000004u) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(3, this->minimal_kappa(), output);
  }

  // optional double lowest_speed = 4 [default = 12];
  if (cached_has_bits & 0x00000008u) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(4, this->lowest_speed(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:apollo.planning.StGenerateDeciderConfig)
}

::google::protobuf::uint8* StGenerateDeciderConfig::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:apollo.planning.StGenerateDeciderConfig)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional double max_curvature_acceleration_limit = 2 [default = 2];
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(2, this->max_curvature_acceleration_limit(), target);
  }

  // optional double minimal_kappa = 3 [default = 0.003];
  if (cached_has_bits & 0x00000004u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(3, this->minimal_kappa(), target);
  }

  // optional double lowest_speed = 4 [default = 12];
  if (cached_has_bits & 0x00000008u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(4, this->lowest_speed(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:apollo.planning.StGenerateDeciderConfig)
  return target;
}

size_t StGenerateDeciderConfig::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:apollo.planning.StGenerateDeciderConfig)
  size_t total_size = 0;
  ...
  if (_has_bits_[0 / 32] & 15u) {
    ...
    // optional double max_curvature_acceleration_limit = 2 [default = 2];
    if (has_max_curvature_acceleration_limit()) {
      total_size += 1 + 8;
    }
...
void StGenerateDeciderConfig::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:apollo.planning.StGenerateDeciderConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const StGenerateDeciderConfig* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const StGenerateDeciderConfig>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:apollo.planning.StGenerateDeciderConfig)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:apollo.planning.StGenerateDeciderConfig)
    MergeFrom(*source);
  }
}

void StGenerateDeciderConfig::MergeFrom(const StGenerateDeciderConfig& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.StGenerateDeciderConfig)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 15u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      max_curvature_acceleration_limit_ = from.max_curvature_acceleration_limit_;
    }
    if (cached_has_bits & 0x00000004u) {
      minimal_kappa_ = from.minimal_kappa_;
    }
...
void StGenerateDeciderConfig::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:apollo.planning.StGenerateDeciderConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void StGenerateDeciderConfig::CopyFrom(const StGenerateDeciderConfig& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:apollo.planning.StGenerateDeciderConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool StGenerateDeciderConfig::IsInitialized() const {
  return true;
}

void StGenerateDeciderConfig::Swap(StGenerateDeciderConfig* other) {
  if (other == this) return;
  InternalSwap(other);
}
void StGenerateDeciderConfig::InternalSwap(StGenerateDeciderConfig* other) {
  using std::swap;
  swap(total_time_, other->total_time_);
  swap(max_curvature_acceleration_limit_, other->max_curvature_acceleration_limit_);
  swap(minimal_kappa_, other->minimal_kappa_);
  swap(lowest_speed_, other->lowest_speed_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::google::protobuf::Metadata StGenerateDeciderConfig::GetMetadata() const {
  protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fplanning_2fproto_2ftask_5fconfig_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::planning::NewTestDeciderConfig* Arena::CreateMaybeMessage< ::apollo::planning::NewTestDeciderConfig >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::planning::NewTestDeciderConfig >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::planning::StGenerateDeciderConfig* Arena::CreateMaybeMessage< ::apollo::planning::StGenerateDeciderConfig >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::planning::StGenerateDeciderConfig >(arena);
}
}  // namespace protobuf
}  // namespace google

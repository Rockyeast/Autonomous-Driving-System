...
#ifndef PROTOBUF_INCLUDED_modules_2fprediction_2fproto_2ffnn_5fvehicle_5fmodel_2eproto
#define PROTOBUF_INCLUDED_modules_2fprediction_2fproto_2ffnn_5fvehicle_5fmodel_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fprediction_2fproto_2ffnn_5fvehicle_5fmodel_2eproto 
...
class FnnVehicleModel : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.prediction.FnnVehicleModel) */ {
 public:
  ...
  inline FnnVehicleModel* New() const final {
    return CreateMaybeMessage<FnnVehicleModel>(NULL);
  }

  FnnVehicleModel* New(::google::protobuf::Arena* arena) const final {
...
inline void FnnVehicleModel::set_allocated_samples_mean(::apollo::prediction::Vector* samples_mean) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(samples_mean_);
  }
  if (samples_mean) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      samples_mean = ::google::protobuf::internal::GetOwnedMessage(
...
inline void FnnVehicleModel::set_allocated_samples_std(::apollo::prediction::Vector* samples_std) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(samples_std_);
  }
  if (samples_std) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      samples_std = ::google::protobuf::internal::GetOwnedMessage(
...
#endif  // PROTOBUF_INCLUDED_modules_2fprediction_2fproto_2ffnn_5fvehicle_5fmodel_2eproto

...
PathPoint PathMatcher::FindProjectionPoint(const PathPoint& p0,
  ...
  double dot = v0x * v1x + v0y * v1y;  //内积

  double delta_s = dot / v1_norm;   //由投影公式，内积除于P0 P1距离=投影的长度deta_s
  return InterpolateUsingLinearApproximation(p0, p1, p0.s() + delta_s);  //线性差值求投影点x,y,z,v,a,k...
}

...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/common/proto/drive_state.proto", schemas, file_default_instances, TableStruct::offsets,
...
const EngageAdvice& EngageAdvice::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto::scc_info_EngageAdvice.base);

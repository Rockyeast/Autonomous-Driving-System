...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/common/proto/error_code.proto", schemas, file_default_instances, TableStruct::offsets,
...
const StatusPb& StatusPb::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fcommon_2fproto_2ferror_5fcode_2eproto::scc_info_StatusPb.base);

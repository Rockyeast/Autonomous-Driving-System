...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/localization/proto/imu.proto", schemas, file_default_instances, TableStruct::offsets,
...
CorrectedImu::CorrectedImu()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2flocalization_2fproto_2fimu_2eproto::scc_info_CorrectedImu.base);
  SharedCtor();
...
const CorrectedImu& CorrectedImu::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2flocalization_2fproto_2fimu_2eproto::scc_info_CorrectedImu.base);

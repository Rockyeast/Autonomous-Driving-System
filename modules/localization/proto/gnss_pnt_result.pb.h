...
#ifndef PROTOBUF_INCLUDED_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto
#define PROTOBUF_INCLUDED_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto 
...
class SatDirCosine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.localization.SatDirCosine) */ {
 public:
  ...
  inline SatDirCosine* New() const final {
    return CreateMaybeMessage<SatDirCosine>(NULL);
  }

  SatDirCosine* New(::google::protobuf::Arena* arena) const final {
...
class GnssPntResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.localization.GnssPntResult) */ {
 public:
  ...
  inline GnssPntResult* New() const final {
    return CreateMaybeMessage<GnssPntResult>(NULL);
  }

  GnssPntResult* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto

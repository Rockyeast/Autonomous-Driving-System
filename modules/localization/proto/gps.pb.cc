...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/localization/proto/gps.proto", schemas, file_default_instances, TableStruct::offsets,
...
Gps::Gps()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2flocalization_2fproto_2fgps_2eproto::scc_info_Gps.base);
  SharedCtor();
...
const Gps& Gps::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2flocalization_2fproto_2fgps_2eproto::scc_info_Gps.base);

...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/localization/proto/pose.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Pose& Pose::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2flocalization_2fproto_2fpose_2eproto::scc_info_Pose.base);

...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_RadarConf;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_CanConf;
}  // namespace protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto
namespace apollo {
namespace drivers {
...
class ContiRadarConfDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ContiRadarConf>
      _instance;
...
static void InitDefaultsContiRadarConf() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<2> scc_info_ContiRadarConf =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsContiRadarConf}, {
      &protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_CanConf.base,
      &protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_RadarConf.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_CanConf.base);
  ::google::protobuf::internal::InitSCC(&scc_info_RadarConf.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ContiRadarConf.base);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, can_card_parameter_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, enable_debug_mode_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, enable_receiver_log_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::CanConf, enable_sender_log_),
  0,
  1,
  2,
  3,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, max_distance_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, sensor_id_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, radar_power_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, output_type_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, send_quality_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, send_ext_info_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, sort_index_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, store_in_nvm_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, ctrl_relay_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, rcs_threshold_valid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, max_distance_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, sensor_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, output_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, radar_power_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, ctrl_relay_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, send_ext_info_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, send_quality_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, sort_index_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, store_in_nvm_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, rcs_threshold_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::RadarConf, input_send_interval_),
  0,
  1,
  2,
  12,
  ...
  10,
  9,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::ContiRadarConf, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::ContiRadarConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::ContiRadarConf, can_conf_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::ContiRadarConf, radar_conf_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::drivers::conti_radar::ContiRadarConf, radar_channel_),
  1,
  2,
  0,
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::drivers::conti_radar::_CanConf_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::drivers::conti_radar::_RadarConf_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::drivers::conti_radar::_ContiRadarConf_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/drivers/radar/conti_radar/proto/conti_radar_conf.proto", schemas, file_default_instances, TableStruct::offsets,
...
const CanConf& CanConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_CanConf.base);
...
const RadarConf& RadarConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_RadarConf.base);
  return *internal_default_instance();
}
...
ContiRadarConf::ContiRadarConf()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_ContiRadarConf.base);
  SharedCtor();
...
const ContiRadarConf& ContiRadarConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fdrivers_2fradar_2fconti_5fradar_2fproto_2fconti_5fradar_5fconf_2eproto::scc_info_ContiRadarConf.base);
  return *internal_default_instance();
}
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->radar_channel().data(), static_cast<int>(this->radar_channel().length()),
...
void ContiRadarConf::InternalSwap(ContiRadarConf* other) {
  using std::swap;
  radar_channel_.Swap(&other->radar_channel_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::drivers::conti_radar::CanConf* Arena::CreateMaybeMessage< ::apollo::drivers::conti_radar::CanConf >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::drivers::conti_radar::CanConf >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::drivers::conti_radar::RadarConf* Arena::CreateMaybeMessage< ::apollo::drivers::conti_radar::RadarConf >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::drivers::conti_radar::RadarConf >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::drivers::conti_radar::ContiRadarConf* Arena::CreateMaybeMessage< ::apollo::drivers::conti_radar::ContiRadarConf >(Arena* arena) {

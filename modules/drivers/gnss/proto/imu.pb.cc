...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/drivers/gnss/proto/imu.proto", schemas, file_default_instances, TableStruct::offsets,
...
Imu::Imu()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2fdrivers_2fgnss_2fproto_2fimu_2eproto::scc_info_Imu.base);
  SharedCtor();
...
const Imu& Imu::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fdrivers_2fgnss_2fproto_2fimu_2eproto::scc_info_Imu.base);

...
#ifndef PROTOBUF_INCLUDED_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto
#define PROTOBUF_INCLUDED_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto 
...
class StreamStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.drivers.gnss.StreamStatus) */ {
 public:
  StreamStatus();
...
class InsStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.drivers.gnss.InsStatus) */ {
 public:
  InsStatus();
  virtual ~InsStatus();
...
class GnssStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.drivers.gnss.GnssStatus) */ {
 public:
  GnssStatus();
  virtual ~GnssStatus();
...
#endif  // PROTOBUF_INCLUDED_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto

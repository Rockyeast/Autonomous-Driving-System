...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_id.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Id& Id::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fid_2eproto::scc_info_Id.base);

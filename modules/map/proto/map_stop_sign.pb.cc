...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_stop_sign.proto", schemas, file_default_instances, TableStruct::offsets,
...
const StopSign& StopSign::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto::scc_info_StopSign.base);

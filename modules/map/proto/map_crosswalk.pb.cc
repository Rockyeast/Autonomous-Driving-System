...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_crosswalk.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Crosswalk& Crosswalk::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto::scc_info_Crosswalk.base);

...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_clear_area.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ClearArea& ClearArea::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fclear_5farea_2eproto::scc_info_ClearArea.base);

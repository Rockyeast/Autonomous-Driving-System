...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_yield_sign.proto", schemas, file_default_instances, TableStruct::offsets,
...
const YieldSign& YieldSign::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto::scc_info_YieldSign.base);

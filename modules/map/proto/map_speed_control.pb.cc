...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_SpeedControl;
}  // namespace protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto
namespace apollo {
namespace hdmap {
...
::google::protobuf::internal::SCCInfo<1> scc_info_SpeedControls =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsSpeedControls}, {
      &protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto::scc_info_SpeedControl.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_speed_control.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SpeedControl& SpeedControl::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto::scc_info_SpeedControl.base);
...
SpeedControls::SpeedControls()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto::scc_info_SpeedControls.base);
  SharedCtor();
...
const SpeedControls& SpeedControls::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fcontrol_2eproto::scc_info_SpeedControls.base);
  return *internal_default_instance();
}

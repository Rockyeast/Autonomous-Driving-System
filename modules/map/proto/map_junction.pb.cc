...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_junction.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Junction& Junction::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fjunction_2eproto::scc_info_Junction.base);

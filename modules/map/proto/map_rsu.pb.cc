...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_rsu.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/map/proto/map_rsu.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::Descriptor* RSU::descriptor() {
  ::protobuf_modules_2fmap_2fproto_2fmap_5frsu_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fmap_2fproto_2fmap_5frsu_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const RSU& RSU::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5frsu_2eproto::scc_info_RSU.base);
...
::google::protobuf::Metadata RSU::GetMetadata() const {
  protobuf_modules_2fmap_2fproto_2fmap_5frsu_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fmap_2fproto_2fmap_5frsu_2eproto::file_level_metadata[kIndexInFileMessages];
}

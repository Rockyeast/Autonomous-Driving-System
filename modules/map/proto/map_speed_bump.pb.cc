...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/map/proto/map_speed_bump.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SpeedBump& SpeedBump::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fmap_2fproto_2fmap_5fspeed_5fbump_2eproto::scc_info_SpeedBump.base);
